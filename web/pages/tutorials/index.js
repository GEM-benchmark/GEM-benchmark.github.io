  ...
  return (
    <Layout>
      ...
      <article>
        ...
        <ul className={utilStyles.list}>
          <li className={utilStyles.listItem}>
            <a href="https://github.com/GEM-benchmark/GEM-benchmark.github.io/blob/main/web/data/notebooks/GEM_modeling_walkthrough.ipynb" target="_blank" className={styles.larger}>From pretrained model to submission</a>
            <span className={utilStyles.smallSpace}></span>
            <small className={utilStyles.lightText}>
              Modeling
            </small>
            <span className={utilStyles.smallSpace}></span>
            <div className={styles.model}>This is an interactive version of the introduction tutorial.</div>
          </li>
          <li className={utilStyles.listItem}>
